...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of CollectionManager.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/jjfernandes87/CollectionManager.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'CollectionManager' => ['CollectionManager/Assets/*.png']
  # }
